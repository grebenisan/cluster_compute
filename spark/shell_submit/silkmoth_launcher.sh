...
function Execute
{
	...
	do
		...
		hadoop fs -put $outFile /${ENV}/EDW/..../CHEV/HYPER_PROF_RSLT/Input/
		RC1=$?
		printf "\t\t\tRC1=$RC1\n"
		if [[ $RC1 -ne 0 ]]
		then
		...
		hadoop fs -mv	/$ENV/EDW/..../CHEV/HYPER_PROF_RSLT/Input/$outFile	\
				/$ENV/EDW/..../CHEV/HYPER_PROF_RSLT/Archive/${archiveName}
		hadoop fs -chmod 775 /$ENV/EDW/..../CHEV/HYPER_PROF_RSLT/Output_Desc/
...
hadoop fs -get /${ENV}/EDW/..../CHEV/HYPER_PROF_RSLT/Input/silkmoth_tbl_list${1}.txt    $inputFile
RC=$?
printf "RC=$RC\n"
if [[ $RC -ne 0 ]]
then
...
hadoop fs -mv /${ENV}/EDW/..../CHEV/HYPER_PROF_RSLT/Input/silkmoth_tbl_list${1}.txt    /${ENV}/EDW/..../CHEV/HYPER_PROF_RSLT/Archive/${archiveName}
RC=$?
if [[ $RC -ne 0 ]]
then
