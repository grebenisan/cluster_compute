# Purpose of creation: to find suspected columns to encrypt the data, version 0
...
#ip_dir='hdfs:///'+ENV+'/EDW/.../CHEV/HYPER_PROF_RSLT/Input/'+file_name
#'op_dir='/'+ENV+'/EDW/.../CHEV/HYPER_PROF_RSLT/Output/'
#'hdfs_file_path='/'+ENV+'/EDW/.../CHEV/HYPER_PROF_RSLT/Input/'+file_name

ip_dir='hdfs:///'+ENV+'/EDW/...CHEV/HYPER_PROF_RSLT/Input/'+file_name
op_dir='hdfs:///'+ENV+'/EDW/.../CHEV/HYPER_PROF_RSLT/Output/'
hdfs_file_path='hdfs:///'+ENV+'/EDW/.../CHEV/HYPER_PROF_RSLT/Input/'+file_name
...
if (file):
	...
	#hdfs_file_archive='/'+ENV+'/EDW/.../CHEV/HYPER_PROF_RSLT/Archive/prfl_'+sys.argv[1]+'_'+timestr+ '.txt'
