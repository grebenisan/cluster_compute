...
"""
Title: Chevelle Hyper Data Profiling Data Classification
...
class OraclePersistence(metaclass=ABCMeta):
    ...
    header = {
        ...
        "Authorization": "Bearer eyJ0eX..........................................................Vcs"}
...
class HyperProfiling:
    ...
    def get_url(cls, endpoint):
        ...
        if cls._endpoint_env == 'dev':
            url = 'https://chevelle-micro-dev.cp-epg2i.domain.com' + endpoint
            return url
            ...
            url = 'https://chevelle-micro.cpi.domain.com' + endpoint
            return url
            ...
            for row in list(rows_to_profile):
                ...
                try:
                    ...
                    try:
                        ...
                        print(summary_msg)
                        sys.exit(0)
                    print('Failed', failed_update_schema, update_response['status'], exc_value)
                    continue
                    ...
                    if not data_empty:
                        ...
                        try:
                            ...
                            table_data_column_empty = table_data_column.rdd.isEmpty()
                            if table_data_column_empty:
                                raise Exception
                        except:
                            exc_type, exc_value, exc_tb = sys.exc_info()
                            try:
                            ...
                            if column_row_count_full >= 1000000:
                                ...
                                try:
                                    ...
                                    if failed_update_response['status'] != 200:
                                        ...
                                        print('Failed', failed_update_schema,
                                              failed_update_response['status'], exc_value)
                                        continue
                        ...
                        print('Empty', success_update_schema, update_response['status'])
                        continue
